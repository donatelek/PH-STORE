    ...
    render() {
        return (
            <div className='returns'>
                ...
                All deliveries are traceable and require a signature, unless you the customer, selects the Standard Shipping - Authority to Leave option. Selecting this option gives the courier authority to leave the parcel unattended at your chosen address if they believe there is a safe place to leave it, and Tluxe will not be responsible for any misplaced or unclaimed parcels.
...
All orders are subject to availability. From time to time we may be waiting for a new delivery. We apologise if your items are unavailable and will contact you to offer a refund or to suggest placing your items on back order, which will ensure you receive them as priority once stock has been delivered to Tluxe.</section>
               ...
               Please notify us within 7 days of receipt of goods if you would like to return your order. Send an email to orders@tluxe.com and request an RA number. Include your order number in this email and notify us which goods you would like to exchange or return.
               ...
               We recommend that all returns and exchanges be sent using a traceable carrier. Tluxe will not be held responsible for packages not received by us that were returned without a tracking number.
